 ...
 * 2016-03-22T13:23:07.722-03:00
 * Generated source version: 3.0.5
 * 
 */
@WebServiceClient(name = "EstoqueWSService", 
                  wsdlLocation = "file:/home/acpm/NetBeansProjects/treinamento/estoquews-web/src/java/src/EstoqueWSServiceCap5.wsdl",
...
public class EstoqueWSService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/home/acpm/NetBeansProjects/treinamento/estoquews-web/src/java/src/EstoqueWSServiceCap5.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(EstoqueWSService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/home/acpm/NetBeansProjects/treinamento/estoquews-web/src/java/src/EstoqueWSServiceCap5.wsdl");
        }
        WSDL_LOCATION = url;
    }
